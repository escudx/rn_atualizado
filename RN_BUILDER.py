...
CAPSULE_ACCENT = (
    _mix_hex(CAPSULE_BG[0], "#4c8bf5", 0.25),
    _mix_hex(CAPSULE_BG[1], "#4c8bf5", 0.18),
)
ACCENT_HOVER = (
    _mix_hex(CAPSULE_ACCENT[0], "#ffffff", 0.18),
    _mix_hex(CAPSULE_ACCENT[1], "#000000", 0.18),
)
BADGE_BG = (
    _mix_hex(CAPSULE_BG[0], "#ffffff", 0.32),
    _mix_hex(CAPSULE_BG[1], "#000000", 0.12),
)
BADGE_TEXT = ACTION_BAR_TEXT
CARD_SECTION_BG = (
    _mix_hex(CAPSULE_BG[0], "#ffffff", 0.1),
    _mix_hex(CAPSULE_BG[1], "#000000", 0.07),
)
HINT_TEXT = (
...
class MemManagerTab(ctk.CTkFrame):
    def __init__(
        ...
        *,
        ...
        header.grid(row=0, column=0, columnspan=header_cols, sticky="ew", pady=(0, 16))
        ...
        accent = ctk.CTkFrame(header, height=4, fg_color=CAPSULE_ACCENT, corner_radius=6)
        accent.grid(row=0, column=0, columnspan=2, sticky="ew", padx=12, pady=(12, 8))
        ...
        self.count_badge.grid(row=1, column=1, sticky="e", padx=12, pady=(0, 4))
        ...
        ).grid(row=2, column=0, columnspan=2, sticky="we", padx=12, pady=(2, 12))
        ...
        list_accent = ctk.CTkFrame(list_card, height=3, fg_color=CAPSULE_ACCENT, corner_radius=6)
        list_accent.grid(row=0, column=0, sticky="ew", padx=12, pady=(12, 6))
        list_accent.grid_propagate(False)
        ...
        self.new_entry.grid(row=0, column=0, sticky="ew", padx=(12, 8), pady=12)
        ...
        self.add_btn.grid(row=0, column=1, sticky="e", padx=(0, 12), pady=12)
        self._rebuild_list()
